    ...
    <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                <a href="{{ route('index') }}#carousel-home" class="nav-item nav-link active">Home</a>
                <a href="{{ route('index') }}#about" class="nav-item nav-link">About</a>
                <a href="{{ route('index') }}#services" class="nav-item nav-link">Service</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Perceive</a>
                    <div class="dropdown-menu m-0">
                        <a href="{{ route('index') }}#projects" class="dropdown-item">Our Project</a>
                        <a href="{{ route('index') }}#team" class="dropdown-item">The Team</a>
                        <a href="{{ route('index') }}#blog" class="dropdown-item">Blog</a>
                    </div>
                </div>
